// box score
export const medianPts36 = 15.6   // 15 in 2017-18
export const median2ptRate = .525 // or .5
export const median3ptRate = .355 // or .33
export const medianFTRate = .766 // or .33
export const avgFGRate = .460;
export const medianAst = 2.8;
export const medianTO = 1.8;
export const medianSTL = 1.1;
export const medianBLK = 0.6;
export const medianPF = 3;
export const eFGAvgRate = .524;
export const TSAvgRate = .56;
export const RB36 = 6.1;
